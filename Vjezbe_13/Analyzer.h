...
// Mon Jan  8 11:23:49 2024 by ROOT version 6.24/08
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     TestStatistic(float mean, float dev);
   virtual void     HypothesisTesting(TString country,float mean, float dev);
private:

   TCanvas *canvas;
   TH1F *histo1, *histo2;
   float data, sum1, sum2;
   TRandom3 *rand;
   float p_value, pH0, pH1;
   float z_score;
   TLine *line;
   TLegend *legend;
};
