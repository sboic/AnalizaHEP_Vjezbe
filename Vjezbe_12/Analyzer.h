...
// Fri Dec 29 12:06:01 2023 by ROOT version 6.24/08
// from TTree signal/tree
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     MVATraining(TString method);
   virtual void     PlotMVA();
   private:
      TH1F *histo_signal[8], *histo_background[8];
      TCanvas *canvas;
      TFile *output_file;
      TFile *file;
      TH1D *MVA_signal, *MVA_background;
      TH1F *eff;
};
